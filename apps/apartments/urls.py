...
from apps.apartments.views.raiting_views import RatingListView, CreateRatingView
...
urlpatterns = [
    ...
    path(
        'advertisements/<int:advertisement_id>/reviews/',
        RatingListView.as_view(),
        name='advertisement-reviews',
    ),
    path(
        'advertisements/<int:advertisement_id>/add-review/',
